...
<section class="bg-gray-50 py-20 px-4 md:px-12 relative overflow-hidden">
  <div class="max-w-7xl mx-auto text-center mb-12 animate-fade-in">
    ...
    <p class="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
      We build trust with every brick. From safe transactions to smart project handling, we make construction hassle-free for you.
    </p>
  </div>
  ...
  <div class="absolute -top-20 -left-20 w-64 h-64 bg-blue-100 rounded-full opacity-20 animate-pulse-slow"></div>
  <div class="absolute -bottom-20 -right-20 w-64 h-64 bg-green-100 rounded-full opacity-20 animate-pulse-slow"></div>
