...
<div>
  ...
  <p class="text-sm text-gray-700 leading-relaxed">
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm">
        <li><a href="/civilcoresolutions/index.php#contact" class="hover:text-red-600 transition">› Architectural Services</a></li>
        <li><a href="/civilcoresolutions/index.php#contact" class="hover:text-red-600 transition">› Plan Approvals</a></li>
        <li><a href="/civilcoresolutions/index.php#contact" class="hover:text-red-600 transition">› Quantity Surveying</a></li>
        <li><a href="/civilcoresolutions/index.php#contact" class="hover:text-red-600 transition">› Structural Drawings</a></li>
        <li><a href="/civilcoresolutions/index.php#contact" class="hover:text-red-600 transition">› Hire Your Engineer</a></li>
        <li><a href="/civilcoresolutions/pages/costcalculator.php" class="hover:text-red-600 transition">› Cost Calculator</a></li>
        <li><a href="/civilcoresolutions/pages/meterialcalculator.php" class="hover:text-red-600 transition">› Material Calculator</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <div class="flex space-x-4 mt-4">
        <a href="/civilcoresolutions/index.php#contact" title="Facebook" class="hover:text-blue-600">
        ...
        <a href="/civilcoresolutions/index.php#contact" title="Instagram" class="hover:text-pink-600">
        ...
        <a href="/civilcoresolutions/index.php#contact" title="LinkedIn" class="hover:text-blue-700">
  ...
  <div class="text-center text-xs sm:text-sm text-gray-500 border-t border-gray-300 py-4 bg-white/80">
    ...
    <p>Designed by <a href="/civilcoresolutions/index.php#contact" class="text-red-600 hover:underline">SMLNexGen LLP</a></p>
  </div>
</footer>
